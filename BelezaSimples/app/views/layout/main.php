    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-dark text-white border-end border-secondary" id="sidebar-wrapper" style="min-height: 100vh; width: 250px;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action bg-dark text-white border-bottom border-secondary p-3" href="/meu_salao_app/agendamentos/index">
                    <i class="fas fa-fw fa-calendar-check me-2"></i>Agendamentos
                </a>
